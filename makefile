...
SRCS = $(addprefix src/, \
       init.c filesysbox.c fuse_stubs.c uptime.c doslist.c dopacket.c \
       fsaddnotify.c fschangemode.c fsclose.c fscreatedir.c \
       ...
       fsunlock.c fswrite.c fswriteprotect.c volume.c utf8.c ucs4.c \
