...
SRCS = $(addprefix src/, \
       ...
       fsexaminenext.c fsformat.c fsinfodata.c fsinhibit.c fsopen.c \
       fsopenfromlock.c fsread.c fsrelabel.c fsrename.c fsseek.c \
       fssetcomment.c fssetfilesize.c fswrite.c fswriteprotect.c volume.c \
